...
Our two previous modeling attempts, with [Modeling in the Tidyverse](https://dsapps-2021.github.io/Class_Slides/u1_d05-modeling/u1_d05-modeling.html) and in [The Trees](https://dsapps-2021.github.io/Class_Slides/u3_d01-trees/u3_d01-trees.html) where problematic.
...
.insight[
`r emo::ji("bulb")` We assume these decisions are additive or independent of each other. Does it have to be and what can we do if we suspect not? (Remember we are Statisticians!)
]
...
.font80percent[(We already gave a decent review in [last class](https://dsapps-2021.github.io/Class_Slides/u3_d02-classtopics/u3_d02-classtopics.html))]
...
- Text Features
- .font80percent[Won't talk but God knows this is on my mind: Random Effects]
...
See our `word2vec` detour when we learned about [Networks Community Detection](https://dsapps-2021.github.io/Class_Slides/u2_d04-community/u2_d04-community.html).
