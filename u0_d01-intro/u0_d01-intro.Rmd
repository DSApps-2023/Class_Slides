...
- You have the latest R (4.0.3) and latest RStudio IDE (1.3) and you are able to install packages with `install.packages(“package_name”)`
...
Go to: http://bit.ly/dsapps2021_tidyverse
