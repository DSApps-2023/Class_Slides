...
- You have a terminal, a.k.a shell (Mac/Windows 10 - See installation instructions [here](https://github.com/DSApps-2021/Class_Slides/blob/main/Apps_of_DS_installations.pdf). Windows 7 and less - 😧)
...
- You have the latest R (4.0.3) and latest RStudio IDE (1.4) and you are able to install packages with `install.packages(“package_name”)`
...
Go to: [bit.ly/dsapps2021_tidyverse](http://bit.ly/dsapps2021_tidyverse)
