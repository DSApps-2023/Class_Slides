...
- You have a terminal, a.k.a shell (Mac/Windows 10 - See installation instructions [here](https://github.com/DSApps-2022/Class_Slides/blob/main/Apps_of_DS_installations.pdf). Windows 7 and less - 😧)
...
- You have the latest R (4.1.X) and latest RStudio IDE (2022.X) and you are able to install packages with `install.packages(“package_name”)`
...
## RStudio Cloud, Binder, Colab Demos
...
Go to: [bit.ly/dsapps2022_tidyverse](http://bit.ly/dsapps2022_tidyverse)
