...
migration_total <- read_rds("../data/migration.rds") %>%
  ...
  mutate(region = case_when(region == "united_kingdom" ~ "uk",
                            ...
                            region == "côte_divoire" ~ "ivory_coast",
...
```{r Ggraph, out.width="100%", fig.asp=0.6}
library(ggraph)
...
(Though this was available only on v0.2.0 `r emo::ji("sad")`)
---
...
Get the legos you need with `build_instructions()` `r emo::ji("surprised")`
]
