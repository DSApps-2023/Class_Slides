...
.insight[
`r emo::ji("bulb")` This is a silly example, do you know how to easily vectorize this function?
]
...
okcupid %>% select(sex, height_cm, is_tall) %>% group_by(sex) %>% sample_n(3)
```
