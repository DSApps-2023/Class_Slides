...
.insight[
`r emoji("bulb")` Many, many such gifts, see [`tidyselect`](https://tidyselect.r-lib.org/reference/select_helpers.html)
]
...
.insight[
`r emoji("bulb")` for better living see `glue::glue("number of rows: {nrow(df)}")`
]
