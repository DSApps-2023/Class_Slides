...
.warning[
`r emoji("bulb")` What you're about to see is not a good modeling/prediction flow. This is just an intro to tidy modeling. Some of the issues with how things are done here will be raised, some will have to wait till later in the course.
]
---
...
```{r echo=FALSE}
tune_res <- read_rds("../data/blogs_rfmod_tune.rds")
tune_res
```
